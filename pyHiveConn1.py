...
mydata = hc.sql("create database newforspark")
mydata.show()
mydata1 = hc.sql("use newforspark")
mydata.show()
mydata2 = hc.sql("create table tablespark(id int)")
mydata.show()
mydata3 = hc.sql("insert into tablespark values(12)")
mydata.show()
mydata4 = hc.sql("select * from  tablespark")
mydata.show()
